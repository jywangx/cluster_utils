...
basic_inter_env = [
    "-x UCC_TL_SHARP_TUNE=0 ",
    "-x UCC_TL_SHARP_DEVICES=mlx5_2:1 -x UCC_TL_SHARP_TUNE=reduce_scatter:0-inf -x SHARP_COLL_ENABLE_SAT=0 -x UCC_TL_SHARP_RS_SWITCH_THERSH=" + str(end_count*4) + " ",
    ...
    "-x UCC_TL_SHARP_DEVICES=mlx5_2:1 -x UCC_TL_SHARP_TUNE=reduce_scatter:0-inf -x SHARP_COLL_ENABLE_SAT=1 -x UCC_TL_SHARP_RS_SWITCH_THERSH=" + str(end_count*4) + " "
]
